...
const props = uni_modules_uviewPlus_libs_vue.defineMixin({
  props: {
    ...
    pageInline: {
      type: Boolean,
      default: () => uni_modules_uviewPlus_libs_config_props.props.popup.pageInline
    },
    // 是否页开启手势滑动
    touchable: {
      type: Boolean,
      default: () => uni_modules_uviewPlus_libs_config_props.props.popup.touchable
    },
    // 手势滑动最小高度
    minHeight: {
      type: [String],
      default: () => uni_modules_uviewPlus_libs_config_props.props.popup.minHeight
    },
    // 手势滑动最大高度
    maxHeight: {
      type: [String],
      default: () => uni_modules_uviewPlus_libs_config_props.props.popup.maxHeight
    }
  }
});
exports.props = props;
